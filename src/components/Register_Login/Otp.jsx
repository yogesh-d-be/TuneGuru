...
// //  <Navbar openOtp={openOtp}/>

// //  {otp && <OtpModal isOpenOtp={otp} closeOtpModal={closeOtp}/>}
...
// function OtpPage() {
//   const [isOpenOtp, setIsOpenOtp] = useState(true); // Set isOpenOtp to true when the page is visited
...
//       <OtpModal isOpenOtp={isOpenOtp} closeOtpModal={closeOtpModal} />
//     </>
//   );
// }
