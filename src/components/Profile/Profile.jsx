...
//     const [editing, setEditing] = useState(false); // State to manage whether editing mode is enabled. Then i easy to decide the appearance of edit mode
...
//                             {/* Assuming you want to display token and _id */}
//                             {/* Or, if you don't want to render these properties, remove them */}
//                             {/* <img onClick={() => navigate('/profile/edit')} src={require('../../assests/Icons/pen.png')}  alt="edit" className="w-6"/> */}
//                         </div>
//                     ))}
//                 </div>
...
// import { ToastContainer, toast } from 'react-toastify';
// import { useNavigate } from "react-router-dom";
// import { customerProfile, deleteUserProfile, deleteProfilePic, updateProfilePic } from "../../service/Api";
// import 'react-toastify/dist/ReactToastify.css';
// import EditProfile from "./EditProfile";
...
//     const userDetails = [
//         { label: "Username", data: profile.username },
//         { label: "Email", data: profile.email },
//         { label: "Mobile Number", data: profile.mobilenumber },
//         { label: "Address", data: profile.address }
//     ];
...
//                 <h1 className="profile-header">Profile</h1>
//                 {profile.userPic ? (
//                     <img src={`/userFile/${profile.userPic}`} alt="Profile" />
//                 ) : (
//                     <img src="" alt="Default" className="w-20" />
//                 )}
//                 <div className="profile-details">
//                     {userDetails.map((detail, index) => (
//                         <div key={index}>
