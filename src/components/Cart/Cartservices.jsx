...
const [selectedPaymentMethod, setSelectedPaymentMethod] = useState("card");
    ...
    <form id="booking-form" onSubmit={placeBooking} className="mo:w-full mo:bg-gray-300 mo:py-6 mo:rounded-lg">
      ...
      <div className="flex flex-wrap mt-6 pb-6 mo:flex mo:flex-col mo:mt-3">
          ...
          <div className=" flex mo:pl-4">
            <Space wrap>
              <div className='flex items-center'>
                ...
                >
                  <Button className='w-[150px] text-center   mo:w-fit size-10'>
                  {selectedTime ?  (isMobile ? `${selectedTime.time}` : `${selectedTime.time} - ${selectedTime.category}`) : 'Select Time' }
                  </Button>
                </Dropdown>
                {selectedTime && (
        ...
        <div className="w-full mt-6">
          <h1 className="font-semibold text-xl ml-6 mb-3 mo:text-lg">Tackling Household Repairs</h1>
 ...
 <button onClick={()=>{
  ...
  }} className="mt-2 px-4 py-1 bg-red-500 text-white rounded-lg font-semibold">reset</button>
 </>
